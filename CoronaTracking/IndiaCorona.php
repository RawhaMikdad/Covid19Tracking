...
<button type="button" style="margin-left:auto;margin-right:auto;display:block;margin-top:8%;margin-bottom:0%">
   <a href="#states" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">STATE-WISE REPORT</a>
</button>

<button type="button" style="margin-left:auto;margin-right:auto;display:block;margin-top:2%;margin-bottom:0%">
   <a href="https://indianhelpline.com/" class="btn btn-primary btn-lg active pl-3 "
...
<section class="corona_update container-fluid">
  <div class="my-5">
      <h3 class="text-uppercase text-center" style="color:darkred">Daily  Update of <span color="#8B0000"> covid-19</span> in INDIA!</h3>
  </div>
  ...
  <div class="table-responsive">
    ...
    <table class="table table-bordered table-striped text-center">
      <tr style="background-color:#9cc850;">
        <th>DATE</th>
        <th>New Patient Confirmed</th>
        <th>New Patient Recovered</th>
        <th>Deaths</th>
        <th>Total Confirmed Till Now</th>
      </tr>
      <?php
              ...
              curl_setopt_array($curl, array(
                CURLOPT_URL => "https://corona-virus-world-and-india-data.p.rapidapi.com/api_india_timeline",
              ...
              <td><?php echo $coronalive[$i]['dailyconfirmed'] ?></td>
              <td><?php echo $coronalive[$i]['dailyrecovered'] ?></td>
              <td><?php echo $coronalive[$i]['dailydeceased'] ?></td>
              <td><?php echo $coronalive[$i]['totalconfirmed'] ?></td>
...
<section class="corona_update container-fluid" id="states">
  <div class="my-5">
      <h3 class="text-uppercase text-center" style="color:darkred">Covid-19  STATE-WISE<span color="#8B0000">LIVE</span> UPDATES IN INDIA!</h3>
  </div>
